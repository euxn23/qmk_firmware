...
LT(META,KC_MHEN),KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, LT(META,KC_HENK),
        KC_LALT, _______, _______, KC_F7,   KC_RPRN,          KC_GRV,            KC_QUOT,          KC_LPRN, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,
    ...
    [META] = LAYOUT_moonlander(
        ...
        _______, _______, _______, _______, _______, _______, _______,           _______, KC_VOLD, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLU, _______,
        _______, _______, _______, _______, _______, _______,                             _______, _______, _______, _______, _______, _______,
        _______, TO(GAME),_______, _______, _______,          _______,           _______,          _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,
    ...
    [GAME] = LAYOUT_moonlander(
        ...
        KC_LALT, TO(BASE),_______, KC_F7,   KC_RPRN,          KC_GRV,            KC_QUOT,          KC_LPRN, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,
